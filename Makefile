...
datasets:
	source venv/bin/activate && convert bundle/analyze/datasets/tap-github/ rawdata/ bundle/analyze/datasets/tap-github/output || convert bundle/analyze/datasets/tap-github/ rawdata/ bundle/analyze/datasets/tap-github/output
